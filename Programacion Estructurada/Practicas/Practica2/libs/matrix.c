 ...
 * Inicializa la semilla para la funcion rand utilizada en la funcion
 * Matrix_fillMatrix.
 */
void Matrix_initializeSeed()
{
    srand(time(NULL));
}

/** Matrix_createMatrix
 * Reserva el espacio en memoria para una matriz de MxN tamano.
 * 
...
/** Matrix_fillMatrix
 * Llena una matriz con numeros aleatorios del 0 al 10.
 * Se recomienda haber inicializado srand, ya sea de manera explicita o
 * con Matrix_initializeSeed(), para evitar repetir resultados en cada
